export default async function handler(req, res) {
  ...
  try {
    ...
    const previewUrl = `https://instantwebsiteai-proxy.vercel.app/preview.html?ts=${Date.now()}&name=${encodeURIComponent(name)}&business=${encodeURIComponent(businessType)}`;
